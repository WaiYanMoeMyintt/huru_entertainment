...
const Show = () => {
    ...
    const day = currentDay.slice(0,1).join(' ');
    console.log(day);
    
  const api =
    "https://api.themoviedb.org/3/tv/airing_today?api_key=1b7c076a0e4849aeefd1f3c429c99a36&language=en-US&page=2"
  ...
  return (
    <div className="today_list mt-5">
      ...
      <Swiper
        ...
        navigation={true}
        modules={[Navigation]}
        className="mySwiper today_swiper"
      >
